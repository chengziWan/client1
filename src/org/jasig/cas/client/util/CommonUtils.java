...
public final class CommonUtils {
    ...
    public static String constructRedirectUrl_customer(final String casServerLoginUrl,
            final String serviceUrl) {
    	System.out.println("casServerLoginUrl========"+casServerLoginUrl);
        return casServerLoginUrl + "/oauth2.0/authorize?response_type=code&client_id=100001&redirect_uri="
