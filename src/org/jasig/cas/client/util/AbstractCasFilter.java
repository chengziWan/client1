...
public abstract class AbstractCasFilter extends AbstractConfigurationFilter {
    ...
    /**
     * Template method to allow you to change how you retrieve the code.
     * @author wcc 20190617
     * @param request the HTTP ServletRequest.  CANNOT be NULL.
     * @return the ticket if its found, null otherwise.
     */
    protected String retrieveCodeFromRequest(final HttpServletRequest request) {
    	return CommonUtils.safeGetParameter(request, "code");
    }
}
