...
public class AuthenticationFilter extends AbstractCasFilter {
    ...
    public final void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse,
    	...
    	System.out.println("client1----------------authenticationfilter--------------------dofilter-----------");
        ...
        if (isRequestUrlExcluded(request)) {
            ...
            System.out.println("client1--------------Request is ignored.");
            return;
        }
        ...
        if (assertion != null) {
            filterChain.doFilter(request, response);
            System.out.println("client1--------------assertion");
            return;
        }
        ...
        if (CommonUtils.isNotBlank(ticket) || wasGatewayed) {
            filterChain.doFilter(request, response);
            System.out.println("client1--------------ticket..wasGatewayed");
            return;
        }
        ...
        //final String urlToRedirectTo = "https://cas.example.org:8443/cas5.3.5/oauth2.0/authorize?response_type=code&client_id=100001&redirect_uri=http://cas.example.org:8080/client1";

        logger.debug("redirecting to \"{}\"", urlToRedirectTo);

        System.out.println("client1--------------urlToRedirectTo="+urlToRedirectTo);
